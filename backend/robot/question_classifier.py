...
class QuestionClassifier:
    def __init__(self):
        # cur_dir = '/robot/QAQ/'.join(os.path.abspath(__file__).split('/')[:-1])
        cur_dir = 'E:/Codes/PyCharmProjects/Medical-big-data-platform/backend/robot/'
        # 　特征词路径
        ...
        self.food_qwds = ['吃什么', '饮食', '饮用', '吃', '食', '伙食', '膳食', '喝', '菜', '忌口', '补品', '保健品',
                          '食谱', '菜谱', '食用', '食物', '补品']
        ...
        self.cureway_qwds = ['治疗', '怎么治疗', '如何医治', '怎么医治', '怎么治', '怎么医', '如何治', '医治方式',
                             '疗法', '咋治', '怎么办', '咋办', '咋治']

        self.cureprob_qwds = ['多大概率能治好', '多大几率能治好', '治好希望大么', '几率', '几成', '比例', '可能性',
                              '能治', '可治', '可以治', '可以医']

        self.easyget_qwds = ['易感人群', '容易感染', '易发人群', '什么人', '哪些人', '那些人', '感染', '染上', '得上']
